 ...
 * <p>
 * Users are also responsible for making sure that the values provided by this interface are used in a thread-safe
 * manner, we recommend checking also the documentation for the corresponding classes.
 *
 * @author fandreuz
 */
